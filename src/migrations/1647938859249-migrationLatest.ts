...
export class migrationLatest1647938859249 implements MigrationInterface {
    name = 'migrationLatest1647938859249'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "news" ("id" SERIAL NOT NULL, "slug" character varying NOT NULL, "title" character varying NOT NULL, "annonce" character varying NOT NULL, "content" character varying NOT NULL, "photos" text, "preview" text, "visible" text NOT NULL DEFAULT 'all', "tags" text, "meta" text NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "authorId" integer, CONSTRAINT "PK_39a43dfcb6007180f04aff2357e" PRIMARY KEY ("id"))`);
